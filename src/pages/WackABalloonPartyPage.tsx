...
const GALLERY = [
  { src: "/PartyEdition1.webp", alt: "Wack A Balloon Party Edition product photo with balloons and two mallets" },
  { src: "/PartyEdition2.webp", alt: "Large group playing Wack A Balloon Party Edition" },
  { src: "/PartyEdition3.webp", alt: "Wack A Balloon Party Edition gameplay with multiple players" },
  { src: "/PartyEdition4.webp", alt: "Party Edition balloon game setup for a group event" },
  { src: "/PartyEdition5.webp", alt: "Players reacting to Wack A Balloon Party Edition suspense" },
  { src: "/PartyEdition6.webp", alt: "Wack A Balloon Party Edition box contents and accessories" },
  { src: "/PartyEdition7.webp", alt: "Family party enjoying Wack A Balloon Party Edition" },
  { src: "/PartyEdition8.webp", alt: "Wack A Balloon Party Edition action shot with balloon challenge" },
];

const HOW_TO_PLAY = [
  {
    step: "01",
    title: "Inflate Your Balloons",
    body: "Each player blows up a balloon to the same size. With 60 balloons in the box, there's plenty to go around for the whole crowd.",
  },
  {
    step: "02",
    title: "Two Players Go Head-to-Head",
    body: "With 2 mallets, two active players compete simultaneously while the rest of the group watches and holds their breath. More action, less waiting.",
  },
  {
    step: "03",
    title: "Last One Standing Wins",
    body: "The player who pops their balloon is out. Keep going until one player is left holding their un-popped balloon — that's your champion!",
  },
];

const CONTENTS = [
  { icon: Package, label: "Balloons",        qty: "×60" },
  { icon: Zap,     label: "Wacking Mallets", qty: "×2" },
  { icon: Play,    label: "Play Modes",      qty: "4" },
  { icon: Users,   label: "Players",         qty: "2–12" },
...
const REVIEWS = [
  {
    ...
    rating: 5,
    date: "March 25, 2026",
    title: "Party Edition is next level!",
    body: "We had 12 people playing and it was absolute chaos — in the best way. The extra balloons and cards make it so much more unpredictable. Can't recommend it enough.",
    verified: true,
    avatar: "AP",
  },
  {
    ...
    title: "Best party game we've ever played",
    body: "Brought this to a birthday party and it was the highlight of the night. Everyone was screaming and laughing. 10/10 would buy again.",
    verified: true,
    avatar: "JK",
  },
  {
    ...
    title: "Great upgrade from the original",
    body: "If you already own Wack A Balloon, the Party Edition adds a whole new layer. More players, more balloons, more chaos. Worth every penny.",
    verified: true,
    avatar: "CM",
  },
  {
    ...
    title: "Brought it to a wedding — instant hit",
    body: "Used this at a wedding reception and it was the best decision of the night. Even grandparents got involved. Two mallets means it never slows down.",
    verified: true,
    avatar: "TF",
  },
  {
    ...
    title: "60 balloons is the right call",
    body: "We burned through all 60 balloons across the night and needed more. That's how good it is. Everyone wants to keep going.",
    verified: true,
    avatar: "NG",
  },
];
...
const FAQS = [
  {
    q: "What's the difference between Wack A Balloon and the Party Edition?",
    a: "The Party Edition includes 60 balloons (vs 30), 2 mallets (vs 1), supports up to 12 players (vs 8), and includes expanded play modes — making it built for large groups and parties.",
  },
  {
  ...
  },
  {
    ...
    a: "Wack A Balloon Party Edition is designed for ages 6 and up. Adult supervision is recommended for younger players.",
  },
  {
    q: "How many players can play at once?",
    a: "The Party Edition supports 2 to 12 players. With 2 mallets, two rounds can happen simultaneously keeping everyone engaged.",
  },
  {
...
const SOCIAL_PROOF = [
  { stat: "74+",  label: "5-Star Reviews" },
  { stat: "20K+", label: "Happy Players" },
  { stat: "12",   label: "Players Supported" },
...
export default function WackABalloonPartyPage({ onBack, onAddToCart }: Props) {
  ...
  const productSchema = JSON.stringify({
    ...
    description: "Wack A Balloon Party Edition is the larger-group version of the viral balloon party game, with two mallets, sixty balloons, and support for up to twelve players.",
    brand: {
      "@type": "Brand",
      name: "Diffy Games"
    },
    sku: "wack-a-balloon-party",
    offers: {
      "@type": "Offer",
      url: "https://diffygames.com/wack-a-balloon-party",
      priceCurrency: "USD",
      price: "29.99",
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: "Wack A Balloon Party Edition", item: "https://diffygames.com/wack-a-balloon-party" },
    ],
  });
  ...
  return (
    <div className="min-h-screen bg-white pb-28 lg:pb-0">
      <Seo
        title="Wack A Balloon Party Edition | Large Group Balloon Party Game"
        description="Shop Wack A Balloon Party Edition from Diffy Games. Built for bigger groups with more balloons, two mallets, and nonstop party energy."
        path="/wack-a-balloon-party"
        image="/PartyEdition1.webp"
        type="product"
        keywords="Wack A Balloon Party Edition, balloon party game for large groups, party game for 12 players, group party game"
      ...
      <div className="border-b border-gray-100">
        <div className="container mx-auto px-4 md:px-6 py-3 flex items-center gap-2 text-sm text-gray-400">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">Wack A Balloon — Party Edition</span>
        </div>
      </div>
        ...
        <div className="lg:grid lg:grid-cols-[1fr_1fr] lg:gap-20 lg:items-start">
          ...
          <div className="mt-8 lg:mt-0">
            ...
            <p className="text-sm text-gray-400 font-medium mb-4 leading-snug">
              Party Edition · Up to 12 Players · 60 Balloons · 2 Mallets · Ages 6+
            </p>
            ...
            <p className="text-gray-500 leading-relaxed mb-8 text-base">
              Everything you love about Wack A Balloon — doubled. The Party Edition brings 60 balloons, 2 mallets, and support for up to 12 players. More chaos, more laughs, more memories.
            </p>

            <div className="flex flex-wrap gap-2 mb-8">
              {["60 Balloons", "2 Mallets", "Up to 12 Players", "Ages 6+", "Indoor & Outdoor"].map((item) => (
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-20 lg:items-center">
            ...
            >
              ...
              <h2 className="font-display uppercase text-4xl lg:text-5xl text-gray-900 leading-none mb-6">
                Double the mallets.<br />Double the chaos.
              </h2>
              <p className="text-gray-500 leading-relaxed text-lg mb-6">
                Wack A Balloon Party Edition is built for the big moments. Whether it's a birthday, a reunion, or a game night that got out of hand — this is the edition that handles the crowd. With support for up to 12 players and double the balloons, no one gets left out.
              </p>
              <p className="text-gray-500 leading-relaxed text-lg mb-8">
                Two mallets mean two active players going head-to-head at once, while the rest of the group holds their breath. The tension is real. The laughter is louder. The memories last longer.
              </p>
              <div className="flex flex-col gap-3">
                {[
                  "Supports up to 12 players — built for big groups",
                  "2 mallets for simultaneous head-to-head action",
                  "60 balloons — enough for a full night",
                  "4 play modes for endless variety",
                ].map((pt) => (
            ...
            >
              <div className="rounded-3xl overflow-hidden bg-gray-50 shadow-xl">
                <img src="/PartyEdition2.webp" alt="Wack A Balloon Party Edition in action" className="w-full h-auto block" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6 max-w-6xl">
          ...
          <div className="text-center mb-16">
            <div className="inline-block bg-purple-600 text-white text-[11px] font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4 shadow-sm">
              Original Game Mode · 28 Ways To Play
            </div>
          ...
          {/* 28 Game Cards callout */}
          <motion.div
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="bg-purple-600 rounded-3xl p-7 text-center shadow-lg mb-6"
          >
            <p className="font-display uppercase text-white text-2xl lg:text-3xl tracking-widest leading-snug drop-shadow">
              28 Different Ways To Play!
            </p>
            <p className="text-purple-200 text-base mt-2 max-w-lg mx-auto">Draw a Game Card before your turn for a wild new rule — dizzy, freeze, speed rounds and more!</p>
          </motion.div>
            ...
            >
              ...
              <ol className="space-y-5">
                {([
                  ...
                  { n: "2", title: "Tie Balloons", body: "Can't tie a knot? Use the included Wack A Balloon ties — they're reusable!" },
              ...
              <div>
                ...
                <ul className="space-y-5">
                  {([
                    ...
                    { title: "Draw a Game Card", body: "Optionally draw one of 28 Game Cards for a wild new challenge each round!", dot: "bg-purple-500" },
                    { title: "Hold the Box", body: "Hold the black box steady while hammering. Be careful not to hit your hands.", dot: "bg-amber-400" },
                    { title: "Don't Pop It!", body: "If the balloon pops on your turn, you may lose — or win! It's up to you!", dot: "bg-red-500" },
                  ] as const).map((s, i) => (
          ...
          <motion.div
            ...
            className="bg-gray-900 rounded-3xl p-8 text-center shadow-lg"
          >
            <p className="font-display uppercase text-white text-2xl lg:text-4xl tracking-widest leading-snug drop-shadow">
              The player who pops the balloon loses —<br className="hidden sm:block" />
              <span className="text-purple-400">or wins! It's up to you!</span>
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="lg:grid lg:grid-cols-2 lg:gap-20 lg:items-center">
            ...
            >
              <div className="rounded-3xl overflow-hidden bg-gray-50 shadow-xl">
                <img src="/PartyEdition3.webp" alt="Wack A Balloon Party Edition contents" className="w-full h-auto block" />
              </div>
            </motion.div>
      ...
      <section className="relative overflow-hidden">
        <img
          src="/PartyEdition5.webp"
          alt="Wack A Balloon Party Edition fun"
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            >
              ...
              <h2 className="font-display uppercase text-white text-4xl md:text-6xl leading-none mb-6">
                The game that takes over the party
              </h2>
              <p className="text-white/70 text-lg mb-8">
                The Party Edition is designed for crowds. Bigger, louder, and more chaotic than anything else on the table.
              </p>
              <motion.button
                whileTap={{ scale: 0.97 }}
                onClick={handleAdd}
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16 mb-14 p-8 bg-white rounded-3xl shadow-sm">
            <div className="text-center shrink-0">
              ...
              <div className="text-sm text-gray-400 mt-2 font-semibold">74 reviews</div>
            </div>
            <div className="flex-1 w-full max-w-sm">
              {[[5, 91], [4, 7], [3, 2], [2, 0], [1, 0]].map(([stars, pct]) => (
      ...
      <section className="py-20 bg-[#3d99f6] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
          ...
          <p className="text-white/80 text-lg mb-10 max-w-lg mx-auto">
            Wack A Balloon Party Edition — made for crowds, built for memories. Get yours today.
          </p>
            ...
            <AnimatePresence mode="wait">
              {added ? (
                ...
                <motion.span key="add" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} className="flex items-center gap-1.5">
                  <ShoppingBag className="w-4 h-4" /> Add to Cart — $29.99
                </motion.span>
              )}
            </AnimatePresence>
          </motion.button>
